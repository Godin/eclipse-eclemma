...
public class DumpExecutionDataTest {
  ...
  public static void setup() throws Exception {
    ...
    terminate1 = project.project.getLocation().toString() + "/launch1";
    ...
    terminate2 = project.project.getLocation().toString() + "/launch2";
  ...
  public static void terminate() throws Exception {
    ...
    Thread.sleep(200);
    assertTrue(launch1.isTerminated());
    assertTrue(launch2.isTerminated());
